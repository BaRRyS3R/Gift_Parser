...
import { Shield, Clock, AlertTriangle, CheckCircle2, RotateCcw } from "lucide-react";
...
export default function BlockedPage(): JSX.Element {
     ...
     */
    const checkUnblockStatus = useCallback(async (isInitialCheck: boolean = false) => {
        ...
        try {
            ...
            setPageState(prev => ({
                ...
                isLoading: false,
                isCheckingUnblock: false,
                error: error instanceof Error ? error.message : 'Failed to check unblock status'
            }));
        } finally {
    ...
    useEffect(() => {
        if (pageState.blockInfo && pageState.timeRemaining > 0 && !pageState.isUnblocked) {
    ...
    }, [pageState.blockInfo, pageState.timeRemaining, pageState.isUnblocked, updateCountdown]);
        ...
        return (
            <div className="min-h-screen bg-black flex items-center justify-center p-6">
                <div className="max-w-md w-full bg-gray-900 border border-green-500/30 rounded-xl p-6 text-center">
                    ...
                    <h2 className="text-xl font-bold text-white mb-2">Account Unblocked</h2>
        ...
        return (
            <div className="min-h-screen bg-black flex items-center justify-center p-6">
                <div className="max-w-md w-full bg-gray-900 border border-gray-700 rounded-xl p-6 text-center">
                    ...
                    <h2 className="text-xl font-bold text-white mb-2">Account Status Unknown</h2>
        ...
        <div className="min-h-screen bg-black flex items-center justify-center p-6">
            <div className="max-w-md w-full bg-gray-900 border border-gray-700 rounded-xl p-6">
                ...
                <div className="bg-gray-800 border border-gray-600 rounded-lg p-4 mb-6">
                    ...
                    <div className="text-center">
                        <p className={`text-2xl font-bold ${pageState.timeRemaining <= 60 ? 'text-red-400' : 'text-white'}`}>
                ...
                <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4 mb-6">
                    ...
                    <div className="text-blue-200 text-xs space-y-1">
                        ...
                        <p>• Your trust score may be adjusted based on the security verification</p>
                    </div>
                </div>

...
type Platform = "ios" | "android" | "chrome" | "firefox" | "safari" | "windows" | "macos" | "linux";
...
const WALLET_CONFIGS = [
    {
        ...
        platforms: ["ios", "android", "chrome", "firefox", "safari", "windows", "macos", "linux"] as Platform[]
    },
    {
        appName: "mytonwallet",
        name: "MyTonWallet",
...
export function TonShopProvider({ children }: TonShopProviderProps) {
    ...
    useEffect(() => {
        ...
        const isValidContext = window.Telegram?.WebApp || window.location.search.includes('initdata');

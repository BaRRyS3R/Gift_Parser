// src/app/seasons/page.tsx - Updated seasons page with enhanced header and Telegram back button
...
import LightRaysHeader from "@/components/backgrounds/LightRaysHeader";
...
function SeasonsPageContent() {
    ...
    return (
        <div className="min-h-screen bg-black text-white safe-area-inset-bottom relative overflow-hidden">
            ...
            {/* Enhanced Header with Light Rays and Top 1 Player */}
            <LightRaysHeader
                seasonName={season.name}
                topPlayer={topPlayer}
                onTopPlayerClick={topPlayer ? () => handlePlayerClick(topPlayer) : undefined}
                className="mb-0"
            />

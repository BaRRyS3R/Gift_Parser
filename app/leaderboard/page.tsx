      ...
      >
        <div className="flex items-center justify-center w-8">
          {position <= 3 ? (
            ...
            <span className="text-yellow-300/80 font-bpdots text-sm font-bold">
              #{position}
            </span>
          )}
        </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          {entry.username && (
            <p className="text-xs text-yellow-300/60 font-bpdots truncate">
              @{entry.username}
            </p>
          )}
        </div>
    ...
    <div className="min-h-screen bg-black text-white pb-20 px-4 pt-12">
          ...
          {currentLeaderboard.length > 0 && (
            ...
            >
              <div className="flex items-center space-x-1">
                ...
                />
                <span
                  className={`font-bpdots font-bold ${
                    isReactionTab
                      ? "text-yellow-300"
                      : isSurvivalTab
                        ? "text-red-300"
      ...
      <div className="space-y-3">
        {currentLeaderboard.length === 0 ? (
          ...
          >
            {isReactionTab ? (
              <Zap className="text-yellow-400/60 mx-auto mb-3" size={32} />
            ) : isSurvivalTab ? (

        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl p-4">
          ...
          <div className="grid grid-cols-4 gap-3">
            ...
            <div className="text-center p-2 bg-yellow-500/20 rounded-lg border border-yellow-400/30">
              <Zap className="text-yellow-400 mx-auto mb-1" size={12} />
              <div className="text-lg font-bold font-bpdots text-yellow-400">
                {user.reaction_games || 0}
              </div>
              <div className="text-xs font-bpdots text-yellow-300/60">
                REACTION
              </div>
            </div>
          ...
          <div className="space-y-4 animate-fade-in">
            ...
            <div className="bg-yellow-500/10 backdrop-blur-xl border border-yellow-400/30 rounded-xl p-4">
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h3 className="text-sm font-bpdots text-yellow-300 font-bold">
                  REACTION MODE STATS
                </h3>
              </div>
              ...
              {(user.reaction_games || 0) === 0 ? (
                <div className="text-center py-4">
                  <Zap className="text-yellow-400/60 mx-auto mb-2" size={24} />
                  <p className="text-yellow-300/60 font-bpdots text-sm">
                    NO REACTION TESTS YET
                  </p>
                  <p className="text-yellow-400/40 font-bpdots text-xs mt-1">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-3 bg-yellow-500/20 rounded-lg border border-yellow-400/30">
                    <Clock className="text-yellow-300 mx-auto mb-1" size={16} />
              ...
              <div className="space-y-2">
                {getAchievements().map((achievement, index) => {
                  ...
                  const isReactionAchievement =
                    achievement.color === "text-yellow-400";

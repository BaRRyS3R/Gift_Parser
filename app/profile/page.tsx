  ...
  const getAchievements = () => {
    ...
    if (user.total_games >= 100)
      achievements.push({
        ...
        desc: t("profile.achievements.descriptions.gamesPlayed", {
          count: 100,
        }),
    ...
    if (user.referral_count >= 1)
      achievements.push({
        ...
        desc: t("profile.achievements.descriptions.invitedFriend", {
          count: 1,
        }),
    ...
    if (user.referral_count >= 5)
      achievements.push({
        ...
        desc: t("profile.achievements.descriptions.invitedFriends", {
          count: 5,
        }),
        color: "text-green-400",
      });
    ...
    if (user.reaction_games >= 10)
      achievements.push({
        ...
        desc: t("profile.achievements.descriptions.reactionTests", {
          count: 10,
        }),
        color: "text-white",
      });
    ...
    if (user.survival_games >= 10)
      achievements.push({
        ...
        desc: t("profile.achievements.descriptions.survivalAttempts", {
          count: 10,
        }),
        color: "text-red-400",
      });
    if ((user.survival_best_time || 0) >= 30000)
      achievements.push({
        ...
        desc: t("profile.achievements.descriptions.secondsSurvival", {
          time: 30,
        }),
        color: "text-red-400",
      });
    if ((user.survival_best_time || 0) >= 60000)
      achievements.push({
        ...
        desc: t("profile.achievements.descriptions.minuteSurvival", {
          time: 1,
        }),
        color: "text-red-400",
      });
    ...
    if ((user.survival_max_level || 0) >= 10)
      achievements.push({
        ...
        desc: t("profile.achievements.descriptions.reachedLevel", {
          level: 10,
        }),
        color: "text-red-400",
      });
    ...
    <div className="min-h-screen bg-black text-white safe-area-inset-bottom px-4 safe-area-inset">
      ...
      <div className="mb-4">
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl p-1">
          <div className="flex">
            {(["stats", "referrals", "history", "achievements"] as const).map(
              (tab) => (
                <button
                  key={tab}
                  className={`
            ...
            <div className="bg-white/10 backdrop-blur-xl border border-white/30 rounded-xl p-4">
              ...
              {(user.reaction_games || 0) === 0 ? (
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="text-center p-3 bg-white/20 rounded-lg border border-white/30">
                    <Trophy className="text-white mx-auto mb-1" size={16} />
                    <div className="text-lg font-bold text-white">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-3 bg-green-500/20 rounded-lg border border-green-400/30">
                      <Users
                        className="text-green-300 mx-auto mb-1"
                        size={16}
                      />
                      <div className="text-lg font-bold text-green-300">

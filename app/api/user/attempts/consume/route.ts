 ...
 */
export async function POST(request: NextRequest): Promise<NextResponse<ConsumeAttemptResponse>> {
    try {
        ...
        const attemptsStatus = await serverUserService.consumeAttemptWithServerValidation(
            telegramIdNumber
        );

 ...
 */
export async function POST(request: NextRequest): Promise<NextResponse<SaveGameResponse>> {
    try {
        ...
        const saveResult = await serverGameService.saveGameResult(telegramIdNumber, gameResult);

        console.log(`Game result saved successfully for user ${telegramIdNumber}:`, {

...
import { verifyRefreshToken, createJWT, createRefreshToken, extractTokenFromHeader } from '@/lib/jwt';
...
export async function POST(request: NextRequest): Promise<NextResponse<RefreshResponse>> {
    try {
        ...
        console.log(`Token refreshed for user: ${user.telegram_id} (${user.first_name})`);

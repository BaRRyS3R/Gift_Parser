...
export async function POST(request: NextRequest): Promise<NextResponse> {
    try {
        ...
        await serverBlockService.markPermissionGranted(attemptId, requiresAppRestart);

        console.log(`Permission granted for attempt ${attemptId}, restart required: ${requiresAppRestart}`);

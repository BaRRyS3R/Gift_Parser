 ...
 */
export async function POST(request: NextRequest): Promise<NextResponse<CreatePurchaseResponse>> {
    try {
        ...
        console.log(`Creating purchase invoice for user ${telegramId}, product: ${productType}`);

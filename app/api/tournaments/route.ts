...
import type { TournamentListResponse, TournamentFilters } from "@/types/tournaments";

/**
 * GET /api/tournaments
 * Получение списка турниров с фильтрацией
 */
export async function GET(request: NextRequest): Promise<NextResponse<TournamentListResponse>> {
    try {

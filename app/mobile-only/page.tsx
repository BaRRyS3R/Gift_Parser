    ...
    switch (reason) {
      case "not_telegram":
        return {
          ...
          description:
            "This application is exclusively available through Telegram. Please access it using our official bot or channel links below.",
          icon: <Bot className="text-white" size={48} />,
        };
      ...
      case "telegram_desktop":
        return {
          ...
          description:
            "Our application is optimized for mobile experiences. Please access it through Telegram on your mobile device for the best performance and functionality.",
          icon: <Smartphone className="text-white" size={48} />,
        };
      ...
      case "telegram_web":
        return {
          ...
          description:
            "For optimal security and performance, please use the Telegram mobile app instead of the web version. Download Telegram on your mobile device and access our bot.",
          icon: <Smartphone className="text-white" size={48} />,
        };
      ...
      default:
        return {
          ...
          description:
            "This application is designed exclusively for mobile devices through Telegram. Please access it using your mobile phone.",
          icon: <Smartphone className="text-white" size={48} />,
        };
    }
  };
    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-6">
      <div className="max-w-md w-full space-y-12">
        ...
        <div className="flex items-center">
          ...
          <div className="px-4 text-white/60 text-sm font-medium">CIRCUSLE</div>
          <div className="flex-1 h-px bg-white/10" />
        </div>

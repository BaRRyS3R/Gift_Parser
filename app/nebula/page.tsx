// src/app/nebula/page.tsx - Nebula Security Verification Page
...
export default function NebulaPage(): JSX.Element {
    ...
    const handleStartVerification = useCallback(() => {
        if (pageState.verificationInProgress || !pageState.verificationType) {
            return;
        }
    ...
    }, [pageState.verificationInProgress, pageState.verificationType]);
        ...
        return (
            <div className="min-h-screen bg-black flex items-center justify-center p-6">
                <div className="max-w-md w-full bg-gray-900 border border-red-500/30 rounded-xl p-6 text-center">
                    ...
                    <h2 className="text-xl font-bold text-white mb-2">Security Check Failed</h2>
            ...
            <div className="min-h-screen bg-black flex items-center justify-center p-6">
                <div className="max-w-md w-full bg-gray-900 border border-green-500/30 rounded-xl p-6 text-center">
                    ...
                    <p className="text-green-300 text-sm mb-4">
                        Your identity has been verified successfully. Your trust score has been restored.
                    </p>
        ...
        return (
            <div className="min-h-screen bg-black flex items-center justify-center p-6">
                <div className="max-w-md w-full bg-gray-900 border border-red-500/30 rounded-xl p-6 text-center">
                    ...
                    <p className="text-gray-400 text-xs">Redirecting to blocked page...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-black flex items-center justify-center p-6">
            <div className="max-w-md w-full bg-gray-900 border border-gray-700 rounded-xl p-6">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-white mb-2">Security Verification Required</h1>
                ...
                <div className="bg-gray-800 border border-gray-600 rounded-lg p-4 mb-6">
                    ...
                    <div className="w-full bg-gray-700 rounded-full h-2 mb-2">
                        <div
                            ...
                            style={{ width: `${Math.min(100, (pageState.trustScore / 100) * 100)}%` }}
                        />
                    </div>
                    ...
                    <div className="flex items-start space-x-2">
                        ...
                        <div>
                            ...
                            <p className="text-yellow-200 text-xs">
                                You have 15 seconds to complete the verification.
                                Failure will result in a temporary account block.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <button
                    ...
                    disabled={pageState.verificationInProgress || !pageState.verificationType}

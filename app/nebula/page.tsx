...
export default function NebulaPage(): JSX.Element {
    ...
    }, [pageState.verificationInProgress, pageState.attemptId, makeAuthenticatedRequest]);
    ...
    const handleStartVerification = useCallback(() => {
        if (pageState.verificationInProgress || !pageState.verificationType || !pageState.attemptId) {
            return;
        }
    ...
    }, [pageState.verificationInProgress, pageState.verificationType, pageState.attemptId]);
                    ...
                    <div className="flex items-start space-x-2">
                        ...
                        <div>
                            ...
                            <p className="text-yellow-200 text-xs">
                                You have one attempt to complete verification. Closing this page or navigating away will result in account blocking. Complete the verification within 15 seconds.
                            </p>
                        </div>
                    </div>
                </div>

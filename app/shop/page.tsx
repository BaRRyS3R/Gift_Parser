...
export default function ShopPage() {
  ...
  const [successAnimation, setSuccessAnimation] =
    useState<SuccessAnimationState>({
      showAnimation: false,
            ...
            {successAnimation.particles.map((particle) => (
              <div
                ...
                style={{
                  ...
                  opacity:
                    successAnimation.animationPhase === "complete"
                      ? 0
                      : particle.opacity,
                }}
              >
          ...
          <div className="relative z-10">
            ...
            <div className="w-full bg-white/10 rounded-full h-2 overflow-hidden">
              <div
                ...
                style={{
                  width: `${Math.min(100, (attemptsRemaining / 10) * 100)}%`,
                }}
              />
            </div>
          </div>
          ...
          >
            {purchaseState.success ? (
              <div className="text-center space-y-4">
                <div className="relative">
                  <CheckCircle
                    className={`text-green-400 mx-auto transition-all duration-1000 ${
                      successAnimation.animationPhase === "explosion"
                ...
                <div>
                  ...
                  <p className="text-green-300/80">{t("shop.attemptAdded")}</p>
                </div>

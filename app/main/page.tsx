...
export default function MainPage() {
  ...
  useEffect(() => {
    ...
    // Start title animation after page loads
      ...
      <div className="text-center z-10 space-y-8">
        ...
        {isLoading ? (
          <div className="space-y-4">
            ...
            <p className="text-lg text-gray-400 font-bpdots">
              Loading user data...
            </p>
          </div>
        ) : (
            ...
            >
              <div className="flex flex-col items-center space-y-6">
                <div className="bg-white/5 backdrop-blur-sm border border-white/20 rounded-xl p-6 max-w-sm">
                  <h3 className="text-lg font-bpdots text-white mb-3">
                    REACTION GAME
                  </h3>
                  <p className="text-sm text-gray-400 font-bpdots">
                    Test your reflexes and reaction speed in our fast-paced
                    circle-clicking challenge
                  </p>
                </div>

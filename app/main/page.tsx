...
export default function MainPage() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`fixed top-22 left-0 right-0 z-30 px-6 transition-all duration-1000 transform ${showTopButtons ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-8"
          }`}
      >

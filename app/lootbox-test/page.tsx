...
export default function InventoryPage() {
  ...
  const filteredInventory = mockUserInventory.filter(
    (item) =>
  ...
  const groupedInventory = {
    collectible_cards: filteredInventory.filter(
      (item) => item.type === "collectible_card",
    ),
      ...
      <div className="min-h-screen bg-black text-white p-4 safe-area-inset">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="flex gap-4 mb-8">
            <Button
              className="bg-gray-800 text-white min-w-20"
          ...
          <CardBody className="p-0">
            <div className="divide-y divide-gray-800">
              ...
              <div className="flex justify-between items-center p-4">
                ...
                <span
                  style={{ color: rarityConfig[selectedItem.rarity].color }}
                >
              ...
              <div className="flex justify-between items-center p-4">
                ...
                <span className="text-white">
                  {selectedItem.type === "collectible_card"
                    ? "Collectible Cards"
                    : "Lootbox"}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center p-4">
                ...
                <span className="text-white">
                  {selectedItem.issued.toLocaleString()}
                </span>
              </div>
            </div>
          </CardBody>
  ...
  return (
    <div className="min-h-screen bg-black text-white safe-area-inset">
      ...
      <div className="p-4 pt-2 pb-2">
        ...
        <div className="mb-4">
          <h1 className="text-2xl font-bold mb-1">Your inventory</h1>
          <div className="flex items-center gap-1 mb-4">
            <span className="text-gray-400">in</span>
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-full" />
          ...
          <div className="text-sm text-gray-400 mb-4">
            Need more items?{" "}
            <span className="text-white font-semibold">Buy on market</span>
          </div>
        </div>
            ...
            >
              <h2 className="text-xl font-semibold flex items-center gap-2">
                ...
                <span className="text-gray-400 font-normal">
                  {groupedInventory.collectible_cards.length}
                </span>
              </h2>
              <div className="flex items-center gap-2">
                <Button
          ...
          <div className="mb-8">
            ...
            >
              <h2 className="text-xl font-semibold flex items-center gap-2">
                ...
                Lootboxes
                <span className="text-gray-400 font-normal">
                  {groupedInventory.lootboxes.length}
                </span>
              </h2>
              <div className="flex items-center gap-2">
                <Button
            ...
            <CardBody className="text-center py-12">
              ...
              <p className="text-gray-400">
                {searchQuery
                  ...
                  : "Your inventory is empty. Play games to earn collectibles!"}
              </p>
            </CardBody>
          </Card>
        )}

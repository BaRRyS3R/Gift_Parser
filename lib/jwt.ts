 ...
 */
export async function generateToken(userId: string, telegramId: number): Promise<string> {
    try {
 ...
 */
export async function setTokenCookie(userId: string, telegramId: number): Promise<void> {

...
export const leagueService = {
   ...
   */
  getLeagueRequirements(leagueName: string): {
    min: number;
    max: number | null;
  } {
    switch (leagueName) {
      case "bronze":
        return { min: 0, max: 299 };
      case "silver":
        return { min: 300, max: 799 };
      case "gold":
        return { min: 800, max: 1999 };
      case "platinum":
        return { min: 2000, max: 3999 };
      case "diamond":
  ...
  async getAllLeagues(): Promise<never> {
    throw new Error(
      "getAllLeagues has been moved to API. Use /api/leagues endpoint with useLeagues hook instead.",
    );
  },
  ...
  async getUserLeagueProgress(): Promise<never> {
    throw new Error(
      "getUserLeagueProgress has been moved to API. Use /api/leagues endpoint with useLeagues hook instead.",
    );
  },
  ...
  async getLeagueLeaderboard(): Promise<never> {
    throw new Error(
      "getLeagueLeaderboard has been moved to API. Use /api/leagues endpoint with useLeagues hook instead.",
    );
  },
  ...
  async getLeagueNeighbors(): Promise<never> {
    throw new Error(
      "getLeagueNeighbors has been moved to API. Use /api/leagues endpoint with useLeagues hook instead.",
    );
  },
  ...
  async getUserRewards(): Promise<never> {
    throw new Error(
      "getUserRewards has been moved to API. Use /api/leagues endpoint with useLeagues hook instead.",
    );
  },
  ...
  async checkAndUpdateLeague(): Promise<never> {
    throw new Error(
      "checkAndUpdateLeague is now a server-side operation handled automatically by game API.",
    );
  },
  ...
  async initializeUserLeague(): Promise<never> {
    throw new Error(
      "initializeUserLeague is now handled automatically during user registration.",
    );
  },
};

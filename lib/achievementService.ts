...
import type { Achievement, AchievementCategory, AchievementType } from "@/types/achievements";
...
export class AchievementService {
    static calculateAchievements(user: User, rankings: UserRankings): AchievementCategory[] {
    ...
    private static getMasteryAchievements(user: User, rankings: UserRankings): AchievementCategory {
        const achievements: Achievement[] = [
            {
                id: "survival_master",
                type: "mastery",
                ...
                icon: "⚔️",
                rarity: "epic",
                isUnlocked: user.survival_best_time >= 120000 && user.survival_max_level >= 10,
            },
            {
                id: "reaction_demon",
                type: "mastery",
                ...
                icon: "⚡",
                rarity: "legendary",
                isUnlocked: user.reaction_best_time > 0 && user.reaction_best_time <= 100,
            },
            {
                id: "physics_genius",
                type: "mastery",
                ...
                icon: "🧠",
                rarity: "legendary",
                isUnlocked: user.physics_best_score >= 10000 && user.physics_games >= 20,
            ...
            },
            {
                ...
                icon: "🌀",
                rarity: "epic",
                isUnlocked: user.rotation_best_time >= 180000 && user.rotation_max_level >= 8,
            },
            {
                id: "perfectionist",
                type: "mastery",
    ...
    private static getSpecialAchievements(user: User, rankings: UserRankings): AchievementCategory {
        const achievements: Achievement[] = [
            {
                id: "elite_survivor",
                type: "special",

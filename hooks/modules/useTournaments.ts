// src/hooks/modules/useTournaments.ts - Tournaments management hook with sanitized data
...
// Re-export types for external use with updated public types
export type {
    Tournament,
    TournamentsData,
    TournamentLeaderboardData,
...
// Updated Tournament User Position interface with sanitized entry
...
// Updated Hook state interface with sanitized data types
interface TournamentsState {
    tournaments: TournamentsData | null;
    selectedTournament: Tournament | null;
    currentDetail: Tournament | null;
    leaderboard: PublicTournamentLeaderboardEntry[]; // Updated to use sanitized type
...
// Updated Tournament Leaderboard Data interface with sanitized types
interface SanitizedTournamentLeaderboardData {
...
/**
 * Tournaments management hook with sanitized data handling
 */
export function useTournaments(
    ...
    const leaderboardCache = useRef<
        Map<
            string,
            {
                data: SanitizedTournamentLeaderboardData;
                timestamp: number;
            }
        >
    >(new Map());
    ...
    /**
     * Fetch specific tournament and its leaderboard with sanitized data
     */
    const fetchTournamentLeaderboard = useCallback(
        async (
            tournamentQuery: string,
            force: boolean = false,
        ): Promise<SanitizedTournamentLeaderboardData | null> => {
            // Check cache first
            ...
            try {
                ...
                const leaderboardData: SanitizedTournamentLeaderboardData = {

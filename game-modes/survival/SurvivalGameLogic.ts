...
export const calculateSurvivalScore = (stats: SurvivalGameStats, level: number): number => {
...
export const getSurvivalDeathCause = (stats: SurvivalGameStats): SurvivalGameResult['deathCause'] => {
...
export const createSurvivalGameResult = (state: SurvivalGameState): SurvivalGameResult => {

// src/game-modes/survival/SurvivalGameManager.tsx - Обновление с локализацией результатов
      ...
      <div className="min-h-screen bg-black flex items-center justify-center p-6 text-white relative overflow-hidden">
        ...
        >
          ...
          >
            ...
            >
              <span className="text-lg">{t("results.survival.correctHits")}</span>
            ...
            >
              <span className="text-lg">{t("results.survival.survivalTime")}</span>

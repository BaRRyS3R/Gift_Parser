        ...
        return (
            <div className="text-center py-12">
                ...
                <p className="text-white/60">
                    {t("tournaments.empty.description")}
                </p>
            </div>
        );
    }

    const renderTournamentGroup = (status: TournamentStatus, tournaments: Tournament[]) => {
    ...
    return (
        <div className="space-y-8">
            {!filterStatus ? (
                ...
                <>
                    {renderTournamentGroup("active" as TournamentStatus, groupedTournaments.active)}
                    {renderTournamentGroup("upcoming" as TournamentStatus, groupedTournaments.upcoming)}
                    {renderTournamentGroup("ended" as TournamentStatus, groupedTournaments.ended)}
                </>
            ) : (

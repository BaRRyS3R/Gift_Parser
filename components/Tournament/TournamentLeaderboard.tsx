                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <div className="text-blue-400/60 text-sm">
                                    {t("tournaments.outOfParticipants", { total: totalParticipants })}
                                </div>
                            </div>
                        </div>
                        <button
                            ...
                            <div className="flex items-center space-x-4 flex-1 min-w-0">
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center space-x-2">
                                        <span className={`font-medium truncate ${entry.isCurrentUser
                                                ? "text-white"
                                                : entry.position <= 3
                                                    ? "text-white"
                                                    : "text-white/90"
                                    ...
                                    <div className="text-xs text-white/60 mt-1">
                                        {entry.games_played} {t("tournaments.gamesPlayed")} • {formatLastPlayed(entry.last_game_at)}
                                    </div>
                                </div>
                            </div>

                            <div className="text-right flex-shrink-0">
                                <div className={`text-lg font-bold ${entry.position === 1
                                        ? "text-yellow-400"
                                        : entry.position === 2
                                            ? "text-gray-300"
                                            : entry.position === 3

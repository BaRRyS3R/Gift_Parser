    ...
    <Card className={`${colors.bg} border ${colors.border} ${className}`}>
      <CardBody className="p-4">
          ...
          <div>
            ...
            <p className="text-white/60 text-sm">
              {t("leagues.leaderboardSection.yourPosition", {
                position: leagues.neighbors.userPosition,
              })}
            </p>
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          {leagues.neighbors.playersAhead.length === 0 &&
            leagues.neighbors.playersBehind.length === 0 && (
        ...
        <div className="mt-4 pt-3 border-t border-white/10">
          <div className="flex items-center justify-between text-xs text-white/60">
            ...
            <span>
              ...
              {leagues.neighbors.league.max_games
                ? ` - ${leagues.neighbors.league.max_games}`
                : "+"}{" "}
              games
            </span>

// src/components/LeagueProgress/index.ts - Updated exports with API integration

// Main league components with API integration
...
export { default as LeagueProgressModal } from "./LeagueProgressModal";
...
// Enhanced components with neighbor functionality and API integration
export { default as LeagueNeighborsDisplay } from "./LeagueNeighborsDisplay";
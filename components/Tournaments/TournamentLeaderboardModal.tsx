...
export default function TournamentLeaderboardModal({
  ...
  const colors = tournament
    ? getFutureTechModeColors(tournament.mode)
                ...
                <div className="flex items-center justify-center py-12">
                  <div className="text-center space-y-4">
                    ...
                    <p className="text-white/80 font-mono text-sm">
                      {t(
                        "tournaments.leaderboard.loadingLeaderboard",
                      ).toUpperCase()}
                    </p>
                  </div>
                </div>
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-3">
                        <div className="flex items-center gap-2">
                          ...
                          >
                            {t(
                              "tournaments.leaderboard.yourPosition",
                            ).toUpperCase()}
                          </h2>
                        </div>
                        <div
                      ...
                      <Card className="bg-blue-500/10 border border-blue-400/30">
                        <CardBody className="p-4 text-center space-y-2">
                          ...
                          <h3 className="text-white font-mono text-sm font-bold">
                            {t(
                              "tournaments.leaderboard.notParticipating",
                            ).toUpperCase()}
                          </h3>
                          <p className="text-blue-300 text-xs font-mono">
                            {t("tournaments.leaderboard.participateFirst", {
                              mode: t(
                                `tournaments.modes.${tournament.mode}` as any,
                              ),
                            }).toUpperCase()}
                          </p>
                        </CardBody>
                      ...
                      <div className="flex items-center gap-3 mb-4">
                        <div className="flex items-center gap-2">
                          ...
                          <h2 className="text-xs font-mono text-yellow-400 tracking-wider">
                            {t(
                              "tournaments.leaderboard.topPlayers",
                            ).toUpperCase()}
                          </h2>
                        </div>

...
function TournamentStatus({ status, colors }: { status: string; colors: any }) {
    ...
    return (
        <div className={`inline-flex items-center gap-2 px-3 py-1 rounded border ${colors.border} ${colors.bg}`}>
...
function TournamentStats({ tournament, colors }: { tournament: Tournament; colors: any }) {
    const t = useT();
    ...
    const statsData = [
        ...
        {
            label: "START",
            value: () => new Date(tournament.start_time).toLocaleDateString("en-US", {
                month: "short",
                day: "numeric"
            }),
            icon: Calendar,
        ...
        {
            label: "MODE",
            value: () => t(`tournaments.modes.${tournament.mode}` as any).toUpperCase(),
            icon: Target,
        },
        {
            label: "STATUS",
            value: () => t(`tournaments.status.${tournament.status}` as any).toUpperCase(),
            icon: Info,
        },
    ];
...
function ParticipationGuide({ tournament, colors }: { tournament: Tournament; colors: any }) {
    const t = useT();
            ...
            <div className="px-4 pb-8">
                    ...
                    >
                        <CardHeader className="pb-3">
                            <div className="flex items-center justify-between w-full">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-mono" style={{ color: colors.primary }}>
                                            {t(`tournaments.modes.${tournament.mode}` as any)} TOURNAMENT
                                        </p>
                                        <div className="mt-2">
                                ...
                                {/* Time Display */}
                                {((tournament.status === "active" || tournament.status === "upcoming") && timeLeft) && (
                                    <div className="text-right">
                        ...
                        <CardBody className="space-y-4">
                            {tournament.description && (
                                <div>
                                    <div className="text-xs font-mono text-white/60 mb-2">DESCRIPTION</div>
                            ...
                            <TournamentStats tournament={tournament} colors={colors} />
                        </CardBody>
                ...
                <Card className="bg-black/60 border border-white/20 mb-6">
                    <CardBody className="p-4">
                        <ParticipationGuide tournament={tournament} colors={colors} />
                    </CardBody>
                </Card>

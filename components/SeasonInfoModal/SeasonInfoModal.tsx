...
export default function SeasonInfoModal({
    ...
    // Handle view details (redirect to seasons page)
    ...
    return (
        <>
            ...
            <div className="fixed bottom-0 left-0 right-0 z-50 animate-slide-up">
                <div
                    className="bg-black/90 backdrop-blur-xl border-2 border-white/30 text-white mx-4 mb-4 relative overflow-hidden"
                    style={{

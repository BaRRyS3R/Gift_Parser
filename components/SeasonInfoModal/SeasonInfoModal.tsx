                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="pl-6 space-y-3 text-sm text-white/80">
                                            <div>
                                                <span className="text-white/60">{t("main.seasonModal.gameMode")}</span>
                                                <span className="ml-2 text-white/90">{t("main.seasonModal.kingOfHill")}</span>
                                            </div>
                                            ...
                                            <div className="space-y-1 text-xs font-mono">
                                                <div className="flex justify-between items-center">
                                                    <span className="text-white/70">{t("main.seasonModal.reaction")}</span>
                                                    <span className="text-white/60">{t("main.seasonModal.noMultiplier")}</span>
                                                </div>
                                                <div className="flex justify-between items-center">
                                                    <span className="text-white/70">{t("main.seasonModal.survival")}</span>
                                                    <span className="text-green-400">×2</span>
                                                </div>
                                                <div className="flex justify-between items-center">
                                                    <span className="text-white/70">{t("main.seasonModal.physics")}</span>
                                                    <span className="text-blue-400">×4</span>
                                                </div>
                                                <div className="flex justify-between items-center">
                                                    <span className="text-white/70">{t("main.seasonModal.rotation")}</span>

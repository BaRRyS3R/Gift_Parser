  ...
  const initializeGyroscope = async () => {
    ...
    if (typeof window === "undefined") {
      ...
      await handleUnsupportedDevice(
        "Gyroscope verification is not available in this environment",
      );
    ...
    if (!window.DeviceOrientationEvent) {
      ...
      await handleUnsupportedDevice(
        "Your device does not support gyroscope verification",
      );
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              ...
              <div className="text-blue-200 text-sm space-y-1">
                ...
                <p>
                  3. Follow the movement instructions to complete verification
                </p>
              </div>
            </div>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              ...
              <div className="text-blue-200 text-sm space-y-1">
                ...
                <p className="text-blue-300 font-medium mt-2">
                  Complete {requiredMovements} distinct movements within 15
                  seconds
                </p>
              </div>
            </div>

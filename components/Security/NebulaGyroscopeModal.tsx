...
const NebulaGyroscopeModal: React.FC<NebulaGyroscopeModalProps> = ({
            ...
            "/api/nebula/gyroscope",
            {
              ...
              body: JSON.stringify({
                ...
                movementData: {
                  ...
                  requiredMovements: TIMING_CONFIG.REQUIRED_MOVEMENTS,
                  timeSpent:
                    TIMING_CONFIG.VERIFICATION_TIMEOUT -
  ...
  const getProgressPercentage = (): number => {
    return Math.min(
      100,
      (state.detectedMovements / TIMING_CONFIG.REQUIRED_MOVEMENTS) * 100,
    );
  };
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              ...
              <div className="text-blue-200 text-sm space-y-1">
                ...
                <p className="text-blue-300 font-medium mt-2">
                  {t("nebula.gyroscope.movementCount", {
                    count: TIMING_CONFIG.REQUIRED_MOVEMENTS,
                  })}
                </p>
              </div>
            </div>

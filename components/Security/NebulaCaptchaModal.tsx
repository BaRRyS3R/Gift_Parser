...
const NebulaCaptchaModal: React.FC<NebulaCaptchaModalProps> = ({
        ...
        try {
            ...
            if (result.verified && result.trustRestored) {
                ...
                setState((prev) => ({
                    ...prev,
                    isValidating: false,
                    error: result.blockReason || t("nebula.captcha.failed"),
                }));
            ...
            setState((prev) => ({
                ...prev,
                isValidating: false,
                error: error instanceof Error ? error.message : t("nebula.captcha.failed"),
            }));
    ...
    const handleTimeout = () => {
        if (!state.attemptMade) {
            setState((prev) => ({
                ...prev,
                error: t("nebula.captcha.timeout"),
                attemptMade: true,
            }));
            ...
            <div className="relative w-full max-w-md mx-4 bg-gray-900 border border-gray-700 rounded-xl p-6 shadow-2xl">
                ...
                <div className="text-center mb-6">
                    ...
                    <h2 className="text-xl font-bold text-white mb-2">
                        {state.isSuccess ? t("nebula.verification.success.title") : t("nebula.captcha.title")}
                    </h2>
                    <p className="text-gray-400 text-sm">
                        {state.isSuccess
                            ? t("nebula.verification.success.message")
                            : t("nebula.captcha.subtitle")}
                    </p>
                </div>
                                ...
                                {state.isLoading ? (
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-center justify-center space-x-2 text-sm">
                                            ...
                                            <span className="text-gray-500">{t("nebula.captcha.timeRemaining")}</span>
                                        </div>
                                        ...
                                        <div>
                                            <input
                                                ...
                                                maxLength={10}
                                                placeholder={t("nebula.captcha.enterAnswer")}
                                                type="text"
                                        ...
                                        <div className="text-center">
                                            <p className="text-gray-500 text-xs">
                                                {t("nebula.captcha.singleAttempt")}
                                            </p>
                                        </div>
                                            ...
                                            >
                                                {state.isValidating ? (
                                                    <>
                                                        ...
                                                        <span>{t("nebula.captcha.verifying")}</span>
                                                    </>
                                                ) : (
                                                    <>
                                                        <Shield size={16} />
                                                        <span>{t("nebula.captcha.verifyAnswer")}</span>
                                                    </>
                                                )}
                                            </button>
                                        </div>
                                    ...
                                    <div className="text-center py-4">
                                        <p className="text-red-400">{t("nebula.captcha.failed")}</p>
                                        <button

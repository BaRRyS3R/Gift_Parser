...
import { generateSecureCaptcha, validateSecureCaptcha } from '@/lib/authService';
        ...
        try {
            ...
            if (result.success) {
                ...
                if (newAttempts >= maxAttempts) {
                    ...
                    setError(`Incorrect captcha. ${maxAttempts - newAttempts} attempts remaining.`);
            ...
            <div className="relative w-full max-w-md mx-4 bg-gray-900 border border-gray-700 rounded-xl p-6 shadow-2xl">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex space-x-3 pt-2">
                            ...
                            <button
                                ...
                                disabled={!userInput.trim() || isValidating || timeRemaining === 0}
                ...
                <div className="mt-6 p-3 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
                    <p className="text-yellow-300 text-xs text-center">
                        Security verification required. Your account will be temporarily blocked if verification fails.
                    </p>
                </div>
            </div>
        </div>

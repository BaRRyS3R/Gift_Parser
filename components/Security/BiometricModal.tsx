...
import { Fingerprint, Eye, Settings, Clock, AlertTriangle, CheckCircle } from 'lucide-react';
            ...
            manager.init(() => {
                ...
                if (!manager.isBiometricAvailable) {
                    ...
                    manager.requestAccess(
                        ...
                        (granted: boolean) => {
                            if (!granted) {
                                setError('Biometric access denied. Please enable biometric authentication in settings.');
                            }
                        }
                    );
                }
            ...
            <div className="relative w-full max-w-md mx-4 bg-gray-900 border border-gray-700 rounded-xl p-6 shadow-2xl">
                ...
                {!isInitialized ? (
                    <div className="text-center py-8">
                        ...
                        <p className="text-gray-400">Initializing biometric authentication...</p>
                    </div>
                ) : !isSupported || error ? (
                    <div className="text-center space-y-4">
                        ...
                        <div className="flex items-center justify-center space-x-2 p-4 bg-red-500/20 border border-red-500/40 rounded-lg">
                            ...
                            <p className="text-red-300 text-sm">{error || 'Biometric authentication not available'}</p>
                        </div>
                        ...
                        <div className="mt-4 p-3 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
                            <p className="text-yellow-300 text-xs text-center">
                                If biometric authentication is not available, your account will be temporarily blocked for security reasons.
                            </p>
                        </div>
                    </div>
                ) : (
                    <div className="space-y-6">
                        ...
                        <div className="bg-gray-800 border border-gray-600 rounded-lg p-4 text-center">
                            ...
                            <h3 className="text-white font-semibold mb-1">{getBiometricTypeName()} Authentication</h3>
                            <p className="text-gray-400 text-sm">Touch the sensor or look at the camera to authenticate</p>
                        </div>
                        ...
                        {isAuthenticating && (
                            <div className="flex items-center justify-center space-x-2 p-3 bg-blue-500/20 border border-blue-500/40 rounded-lg">
                                ...
                                <p className="text-blue-300 text-sm">Please complete biometric authentication on your device</p>
                            </div>
                        )}
                    </div>
                )}

            ...
            try {
              ...
              if (response.ok) {
                ...
                setState((prev) => ({
                  ...
                  currentPhase: "permission_granted",
                  gracePeriodRemaining:
                    (result.gracePeriodMinutes || 5) * 60 * 1000, // Convert to milliseconds
                  gracePeriodTimerActive: true,
                }));
              ...
              <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <p className="text-yellow-200 text-xs">
                    If you don&apos;t restart the application within the time limit,
                    you will be blocked and need to try verification again
                    later.
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              ...
              <div className="text-blue-200 text-sm space-y-1">
                ...
                <p>2. Enable biometric authentication when prompted</p>
                <p>
              ...
              <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <p className="text-orange-200 text-xs">
                    ...
                    reopen the application for the changes to take effect. You
                    will have 5 minutes to restart.
                  </p>
                </div>
              </div>
            </div>

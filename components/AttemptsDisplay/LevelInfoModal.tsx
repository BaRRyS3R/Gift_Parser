              ...
              <div className="space-y-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-white/70">
                    {t("levels.modal.totalGames", {
                      games: userLevel.totalGames,
                    })}
                  </div>
                </div>
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between text-sm">
                          <span className="text-white/70">
                            {t("levels.modal.currentProgress")}
                          </span>
                        ...
                        <div className="text-center">
                          <span className="text-white/80 text-sm">
                            {t("levels.modal.gamesToNext", {
                              games: userLevel.gamesToNextLevel,
                            })}
                          </span>
                        </div>
                      </div>
                ...
                <div>
                  ...
                  <div className="space-y-3 text-sm text-white/80">
                    ...
                    <div className="flex items-start space-x-3">
                      <div className="w-1 h-1 rounded-full bg-white/40 mt-2 flex-shrink-0" />
                      <span>
                        {t("levels.modal.rule4", { maxLevel: MAX_LEVEL })}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm font-mono">
                    <div className="flex justify-between items-center">
                      <span className="text-white/70">
                        {t("levels.modal.reactionMode")}
                      </span>
                      <span className="text-blue-400">
                        ✓ {t("levels.modal.counts")}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-white/70">
                        {t("levels.modal.survivalMode")}
                      </span>

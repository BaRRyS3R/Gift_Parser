 ...
 */
function checkAndBlockSupabaseAccess(request: NextRequest): NextResponse | null {
    ...
    const suspiciousPatterns = [
        ...
        authorization && !authorization.startsWith('Bearer ey') && authorization.startsWith('Bearer'),
    ];

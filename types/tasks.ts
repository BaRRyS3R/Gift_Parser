...
export interface TaskService {
    ...
    completeTask: (taskId: number, verificationData?: any) => Promise<TaskCompletionResponse>;
    verifyTask: (taskId: number, verificationType: TaskType, verificationData?: any) => Promise<TaskVerificationResponse>;
}

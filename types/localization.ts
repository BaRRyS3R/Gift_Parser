// src/types/localization.ts - Types and utilities for localization
...
// Ensure Russian translations follow the same structure
export type RussianTranslations = typeof ru;
...
export function interpolateString(str: string, params?: TranslationParams): string {
...
export function getPlural(count: number, singular: string, few: string, many: string): string {
...
export function detectLanguageFromTelegram(languageCode?: string): SupportedLanguage {
    // If language code is 'ru', return Russian, otherwise default to English

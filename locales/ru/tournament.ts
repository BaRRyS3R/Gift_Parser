// src/locales/ru/tournament.ts - Обновленная локализация с новыми строками для полного отображения победителей

export const tournament = {
  title: "ТУРНИР",
  noActiveTournament: "Нет Активных Турниров",
  noActiveTournamentDesc:
    "В данный момент нет активных турниров. Проверьте позже для получения информации о предстоящих турнирах!",
  ...
  resultRecordedLocally:
    "Ваш результат записан локально, но не синхронизирован",
  ...
  checkBackLater:
    "Проверьте позже для получения информации о предстоящих турнирах",
  ...
  conceptDescription:
    "Турнир работает по принципу «Король Горы» — каждая игра приносит очки, которые накапливаются в общем зачете. Побеждает тот, кто набрал наибольшее количество очков за все свои игры в турнире.",
  ...
  finalNote:
    "Помните: в турнире «Король Горы» количество игр может быть ключевым фактором успеха. Чем больше очков вы накопите, тем выше ваша позиция в финальной таблице лидеров.",

  // НОВЫЕ СТРОКИ ДЛЯ ПОЛНОЙ ЛОКАЛИЗАЦИИ

  // Спонсорские элементы
  sponsor: "Спонсор",
  sponsorChannel: "Канал спонсора",
  ...
  waitForReset: "Ожидайте сброса попыток",

  // Статусы турниров
  upcoming: "Предстоящий",
  starting: "Начинается",
  untilStart: "до начала турнира",
  starts: "Начинается",

  // Призы и участники
  prizesShort: "призов",
  participantsShort: "участников",
  ...
  rules: {
    ...
    scoring: {
      ...
      detail5:
        "В случае одинакового количества очков побеждает наибольшее время выживания",
      detail6:
        "Турнирная таблица обновляется в реальном времени после каждой игры",
    },
    format: {
    ...
    fairPlay: {
      ...
      detail5:
        "Нарушения могут привести к постоянному запрету участия в турнирах",
    },
    tips: {
      title: "Профессиональные советы",
      description: "Стратегии для успеха в турнире",
      detail1:
        "Тренируйтесь в обычном режиме выживания перед участием в соревновании",
      ...
      detail6:
        "Играйте в несколько игр для накопления большего количества очков",
    },
  },
} as const;

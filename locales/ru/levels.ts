...
export const levels = {
    ...
    modal: {
        ...
        maxLevelDescription: "Вы достигли наивысшего возможного уровня в системе. Поздравляем с вашей преданностью!",

        howItWorks: "КАК РАБОТАЮТ УРОВНИ",
        rule1: "Играйте в любой игровой режим для получения прогресса к следующему уровню",
        rule2: "Каждые {games} завершенных игр повышают ваш уровень на 1",
        rule3: "Каждое повышение уровня награждает {attempts} дополнительными попытками",
        ...
        automaticNote: "Повышения уровня и награды попытками применяются автоматически после каждой игры.",
        rewardNote: "Бонусные попытки от повышения уровня являются постоянными добавлениями к балансу вашего аккаунта.",
    },
} as const;
...
export const levels = {
  ...
  modal: {
    ...
    rule2: "Каждые 20 завершенных игр повышают ваш уровень на 1",
    rule3: "Каждое повышение уровня награждает 10 дополнительными попытками",
    rule4: "Максимально достижимый уровень: большой.",
    ...
    automaticNote:
      "Повышения уровня и награды попытками применяются автоматически.",
    rewardNote: "Бонусные попытки is good ma boy.",
  },
} as const;

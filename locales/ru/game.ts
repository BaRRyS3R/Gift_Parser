...
export const game = {
  ...
  modes: {
    ...
    reaction: {
      ...
      duration: "~10 секунд",
      objective: "Быстрее клик = лучше реакция. Вот и всё.",
      features: [
        "Один круг (не Михаил)",
      ...
      playAgain: {
        ...
        autoRedirect: "Автоматический переход в меню через 5 секунд...",
    ...
    rotation: {
      ...
      objective:
        "Круги вращаются. Жми на белый, избегай красного. Звучит просто? Не совсем.",
      features: [
        "Вращающиеся круги",
        "Уровни",
        "Скорость растёт. Всё труднее угнаться",
        "Ю спин ми райт нау бейби райт нау",
      ],
      rules: [
        "Жмите на белые круги",

...
export const main = {
  ...
  seasonModal: {
    ...
    rulesDescription:
      "Все режимы игры засчитываются, но каждый имеет свой коэффициент очков. Потому что справедливость — это когда всем одинаково неудобно.",
    reaction: "Реакция",
    survival: "Выживание",
    physics: "Физика",
    rotation: "Вращение",
    ...
    fairPlayInfo:
      "При подозрении в нечестной игре мы можем провести дополнительную проверку пользователя перед выдачей приза.",

...
export const main = {
  ...
  seasonModal: {
    ...
    rulesDescription: "Все режимы игры засчитываются, но каждый имеет свой коэффициент очков. Потому что справедливость — это когда всем одинаково неудобно.",
    reaction: "Реакция",
    survival: "Выживание",
    physics: "Физика",
    rotation: "Вращение",
    noMultiplier: "без множителя (классика жанра)",
    rulesNote: "Помните: чем сложнее режим, тем больше очков. Логично, не правда ли?",

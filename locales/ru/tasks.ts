...
export const tasks = {
  ...
  errors: {
    ...
    invalidTaskState:
      "Задание находится в неправильном состоянии для этого действия",
    telegramVerificationError:
      "Ошибка проверки Telegram, убедитесь, что вы подписаны",
  ...
  descriptions: {
    telegram_channel:
      "Подпишитесь на Telegram канал и будьте в курсе обновлений",
    telegram_chat: "Присоединитесь к Telegram чату и станьте частью сообщества",
    twitter_follow:
      "Подпишитесь на аккаунт в Twitter для получения последних новостей",
    twitter_repost:
      "Сделайте репост твита, чтобы помочь распространить информацию",
  ...
  instructions: {
    telegram_channel:
      "Нажмите Подписаться, чтобы открыть Telegram, затем вернитесь для проверки",
    telegram_chat:
      "Нажмите Вступить, чтобы открыть Telegram, затем вернитесь для проверки",
    twitter_follow:
      "Нажмите Подписаться, чтобы открыть Twitter, затем вернитесь для завершения",
    twitter_repost:
      "Нажмите Репост, чтобы открыть Twitter, затем вернитесь для завершения",
    website_visit:
      "Нажмите Посетить, чтобы открыть сайт, затем вернитесь для завершения",
    verification_wait:
      "После выполнения действия нажмите Проверить для подтверждения",
  ...
  info: {
    ...
    trustVerification:
      "Выполнение задания проверяется на основе подтверждения пользователя",
    ...
    manualConfirmation:
      "Пожалуйста, подтвердите, что вы выполнили требуемое действие",
    rewardInfo:
      "Выполняйте задания, чтобы заработать дополнительные попытки игры",

    ...
    game: {
        modes: {
            ...
            survival: {
                ...
                deathCauses: {
                    miss: "Failed to hit white target in time",
                    wrongClick: "Clicked inactive target",
                    decoyHit: "Clicked red trap circle",
                    default: "Survival completed",
                },
                levels: {

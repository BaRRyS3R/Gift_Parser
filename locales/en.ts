...
export const en = {
    ...
    game: {
        modes: {
            ...
            physics: {
                ...
                deathCauses: {
                    mistakes: "Too many mistakes - all walls destroyed",
                    escapedCircles: "Circles escaped the container",
                    timeout: "Time's up",
                    default: "Physics experiment ended",
                },
            },
        },
        general: {
    ...
    profile: {
        ...
        noPhysicsAttemptsYet: "No physics experiments yet",
        enterPhysicsToSeeStats: "Try physics mode to see stats",

...
export const ru = {
    ...
    profile: {
        ...
        noReactionTestsYet: "Ещё нет тестов реакции",
        testReflexesToSeeStats: "Проверьте рефлексы чтобы увидеть статистику",
        noSurvivalAttemptsYet: "Ещё нет попыток выживания",

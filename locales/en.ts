...
export const en = {
    ...
    game: {
        modes: {
            ...
            physics: {
                name: "PHYSICS MODE",
                description: "Master dynamic physics with explosive impulses and destructible barriers",
                difficulty: "Experimental",
                duration: "~2 minutes",
                objective:
                    "Survive by clicking white circles to create impulses that push other circles away. Avoid mistakes or watch the walls disappear one by one.",
                features: [
                    "20 circles with realistic physics",
                    "Impulse explosions on correct hits",
                    "Destructible wall system",
                    "Mistake-based difficulty scaling",
                ],
                rules: [

...
export const ru = {
    ...
    game: {
        modes: {
            ...
            reaction: {
                ...
                difficulty: "Средний",
                duration: "~10 секунд",
                objective: "Кликните по целевому кругу как можно быстрее при его появлении для измерения времени реакции.",
                features: [
                    "Точность одной цели",
                ...
                scoring: "Счёт рассчитывается на основе времени реакции: Молния (≤150мс) = бонус 1.5x, Отлично (≤200мс) = бонус 1.3x, Хорошо (≤300мс) = бонус 1.1x. Базовый счёт = 1000 - время_реакции_мс.",
                instructions: {
            ...
            survival: {
                ...
                duration: "До провала",
                objective: "Выживайте как можно дольше, кликая по белым кругам и избегая красных кругов-ловушек на все более сложных уровнях.",
                features: [
        ...
        general: {
            ...
            resetIn: "Сброс через:",
            automaticReset: "Попытки сбрасываются автоматически через 2 минуты",
    ...
    profile: {
        ...
        referrals: {
            ...
            theyGetExtra: "Они получат +{bonus} дополнительную попытку при присоединении",
    ...
    errors: {
        ...
        unknownError: "Произошла неизвестная ошибка",
        paymentCancelled: "Платёж был отменён или не удался. Пожалуйста, попробуйте снова.",

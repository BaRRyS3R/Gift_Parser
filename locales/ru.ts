...
export const ru = {
    ...
    profile: {
        ...
        enterPhysicsToSeeStats: "Сыргайте в режим с физикой для просмотра статистики",
        ...
        referrals: {
            ...
            theyGetExtra: "Они получают дополнительные попыткы за регистрацию по вашей ссылке.",

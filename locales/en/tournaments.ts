...
export const tournaments = {
  ...
  rules: {
    ...
    survival:
      "Survive as long as possible by hitting white targets and avoiding red traps. The longer you survive, the more points you earn.",
    physics:
      "Hit active targets in a physics world with gravity. Watch your mistakes - maximum 5 misses allowed.",
    rotation:
      "Targets rotate in a circle. Hit white targets and avoid red traps. Requires precision and quick reactions.",
  },
} as const;

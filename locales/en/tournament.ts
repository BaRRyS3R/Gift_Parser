...
export const tournament = {
  ...
  conceptDescription:
    "The tournament operates on a 'King of the Hill' principle — each game awards points that accumulate in your overall score. The winner is whoever accumulates the most points across all their tournament games.",

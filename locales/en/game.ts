...
export const game = {
  gyroscope: {
    modal: {
      ...
      manualTitle: "ENABLE IN SETTINGS",
      manualDescription: "Gyroscope access was denied. Please enable it manually in browser settings.",
      requirement: "SYSTEM REQUIREMENT",
      manualRequired: "MANUAL CONFIGURATION",
      explanation: "Grant permission to enable advanced game features in future updates.",
      manualInstructions: "To enable gyroscope access, go to Safari settings:",
      safariPath: "Settings → Safari → Motion & Orientation → Allow",
      manualHelp: "After enabling in settings, press 'Check Again'",
      error: "ERROR",
      requesting: "REQUESTING PERMISSION...",
      checking: "CHECKING...",
      grantAccess: "GRANT ACCESS",
      recheckAccess: "CHECK AGAIN",

...
export const nebula = {
    ...
    biometric: {
        ...
        instructions: {
            title: "Instructions:",
            step1: "1. Tap \"Grant Permission\" below",
            step2: "2. You may need to temporarily leave the app to enable biometric access in settings",
            step3: "3. Return to this app and authentication will begin automatically",
        },
    ...
    blocked: {
        ...
        reasons: {
            ...
            verification_abandonment: "Verification was abandoned or left",

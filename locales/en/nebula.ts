...
export const nebula = {
  ...
  verification: {
    ...
    warningBan:
      "Closing this page or navigating away will result in account blocking. Complete verification within the allotted time.",
    warningBiometricSafe: "Safe Navigation During Permission Setup",
    warningBiometricText:
      "You can safely exit this app when granting biometric permissions or gyroscope permissions. Your verification session is active for 5 minutes. Avoid exiting only during actual authentication.",
    // Verification types
    types: {
      captcha: {
        name: "CAPTCHA",
      ...
      biometric: {
        name: "BIOMETRIC",
        description:
          "Use biometric authentication. We hope your fingers still work.",
      },
      gyroscope: {
        name: "GYROSCOPE",
        description:
          "Spin your device around. Don't overdo it or you'll get dizzy.",
      },
    },
    ...
    success: {
      ...
      message:
        "Your identity has been successfully verified. Your trust score has been restored.",
    ...
    failure: {
      ...
      message:
        "Identity verification was unsuccessful. Your account will be temporarily blocked.",
  ...
  biometric: {
    ...
    instructions: {
      ...
      step3:
        "3. If redirected to settings, enable biometric access for this app",
      step4: '4. Return here and tap "Check Permission Status" to verify',
      step5:
        "5. You may need to restart the application if the system does not update immediately.",
    },
    ...
    errors: {
      ...
      permissionDenied:
        "Biometric permission was not granted after multiple attempts",
    ...
    securityPolicyText:
      "Due to security requirements, accounts with very low trust scores require biometric authentication. Since your device does not support this feature, your account will be blocked for security reasons.",
    unavailableWarning:
      "Biometric authentication is unavailable on your device. Your account will be blocked in accordance with security policy.",

    // Updated permission warning with attempt tracking
    permissionWarning:
      "To continue, you must grant permission for biometric authentication. Refusal to grant permission will result in your account being blocked.",
    leaveAppSafe: "Safe to Leave App During Permission Setup",
    leaveAppSafeText:
      "You can safely minimize or switch away from this app while granting biometric permission. Your verification session will remain active. Only stay on this page during the actual authentication phase.",
    ...
    blockWarningUnavailable:
      "Your account will be blocked for 2 days as biometrics are unavailable on the device.",
    blockWarningPermissionDenied:
      "Your account will be blocked for 2 days due to biometric permission denial.",
    ...
    attemptTracking: {
      ...
      multipleAttemptsAllowed:
        "Multiple attempts available if permission setup fails",
    },
  },
  ...
  gyroscope: {
    ...
    movement3:
      "• Rotate your device clockwise or counterclockwise (12+ degrees)",
    ...
    important: "Important",
    oneAttempt:
      "You have only one attempt to complete this verification. Make sure your device can move freely before starting.",
    ...
    errors: {
      ...
      permissionDenied:
        "Gyroscope permission was not granted after multiple attempts",
      permissionCheckFailed: "Checking gyroscope permission status...",
      noData:
        "No gyroscope data detected - please ensure your device supports motion sensing",
    ...
    securityPolicy: "Security Policy",
    securityPolicyText:
      "Accounts with extremely low trust scores require gyroscope verification. Since your device does not support this feature, your account will be temporarily blocked.",
    unavailableWarning:
      "Gyroscope verification is unavailable on your device. Your account will be blocked in accordance with security policy.",

    // Updated permission warning
    permissionWarning:
      "Gyroscope access permission is required to continue. Denying permission will result in account blocking.",
    ...
    blockWarningUnavailable:
      "Your account will be blocked for 1 month as gyroscope is unavailable on the device.",
    blockWarningPermissionDenied:
      "Your account will be blocked for 1 month due to gyroscope permission denial.",
  ...
  blocked: {
    ...
    reasons: {
      ...
      biometric_permission_denied:
        "Biometric authentication permission denied after multiple attempts",
      gyroscope_permission_denied:
        "Gyroscope access permission denied after multiple attempts",
    ...
    unblocked: {
      ...
      message:
        "Your account has been successfully unblocked. You can now access the application.",
    ...
    appeal: {
      ...
      subtitle:
        "If you believe your account was blocked in error or due to technical issues",
      contact: "Contact us:",
      ...
      technicalIssues:
        "Common technical issues: permission dialogs not appearing, device compatibility problems, app crashes during verification.",
    },
  ...
  troubleshooting: {
    ...
    biometric: {
      ...
      noPermission:
        "If permission dialog doesn't appear, manually enable biometric access in device settings",
      noSensor:
        "Verify your device has fingerprint or face recognition capabilities",
      notEnrolled:
        "Ensure you have set up biometric authentication in device settings",
      appPermissions:
        "Check app permissions in device settings for biometric access",
    },
    gyroscope: {
      title: "Gyroscope Issues",
      noPermission:
        "If permission dialog doesn't appear, manually enable motion access in device settings",
      noSensor:
        "Verify your device has motion sensors (accelerometer/gyroscope)",
      calibration:
        "Try calibrating your device's motion sensors in device settings",
      sensitivity:
        "Move device with distinct 12+ degree movements, not small shakes",
    },
    general: {

...
export const tasks = {
  ...
  instructions: {
    telegramChannel:
      "Join the Telegram channel using the link below, then click Complete to verify your subscription",
    telegramChat:
      "Join the Telegram chat using the link below, then click Complete to verify your membership",
    twitterFollow:
      "Follow the Twitter account using the link below, then click Complete to verify your subscription",
    twitterRepost:
      "Repost the Twitter post using the link below, then click Complete to verify your repost",
    visitWebsite:
      "Visit the website using the link below, then click Complete to earn your reward",
    telegramStory:
      "Share the content to your Telegram Stories using the link below, then click Complete to verify your post",
    general:
      "Complete the required action using the link below, then click Complete to earn your reward",
  },
